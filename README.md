...
- **Automatisation** : n8n (Workflows et alertes)
...
- **Documentation de l'API** : Intégration de Swagger/OpenAPI pour l'exploration des endpoints REST
- **Déploiement Continu (CI/CD)** : Mise en place de GitHub Actions pour l'exécution automatique des tests
- **Observabilité** : Ajout de Prometheus et Grafana pour monitorer la santé des workers Go et de l'API Spring Boot
- **Historisation avancée** : Stockage des données dans une base Time-Series (ex: InfluxDB) pour l'affichage de graphiques d'évolution
- **Frontend** : Support PWA (Progressive Web App) pour une meilleure expérience mobile
